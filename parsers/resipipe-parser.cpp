...
int main(void)
{
    ...
    save_throughput("FD" ,"fd", read_file, write_file, three_operator_config);
    save_throughput("SA", "sa", read_file, write_file, three_operator_config);
    save_throughput("SD", "sd", read_file, write_file, four_operator_config);
    save_throughput("TM", "tm", read_file, write_file, four_operator_config);
