...
inline void run() {
    ...
    relative_difference("FD", "OpenMPI", "ResiPipe", fd_mpi_mean, fd_res_mean);
    relative_difference("SA", "OpenMPI", "ResiPipe", sa_mpi_mean, sa_res_mean);
    relative_difference("SD", "OpenMPI", "ResiPipe", sd_mpi_mean, sd_res_mean);
    relative_difference("TM", "OpenMPI", "ResiPipe", tm_mpi_mean, tm_res_mean); 

    relative_difference("FD", "Flink", "OpenMPI", fd_flink_mean, fd_mpi_mean);
    relative_difference("SA", "Flink", "OpenMPI", sa_flink_mean, sa_mpi_mean);
    relative_difference("SD", "Flink", "OpenMPI", sd_flink_mean, sd_mpi_mean);
    relative_difference("TM", "Flink", "OpenMPI", tm_flink_mean, tm_mpi_mean); 
}